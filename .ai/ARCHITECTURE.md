...
| `ADR-030` | Schedule provider-neutral integration sync in a closed native runtime; handlers prepare outside SQLite and atomically commit normalized data plus Integration state. | Accepted | `docs/decisions/030-integration-sync-runtime.md` |
