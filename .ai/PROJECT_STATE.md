...
| `RELEASE-032`      | Consolidate and install Alpha 0.3.2                | `self_review` | Merged AI, migration, and UI work ships as a versioned, hashed, installed, and CI-green Windows release candidate.                  |

`RELEASE-032` is locally built, installed, and self-reviewed; draft-PR publication and refreshed GitHub CI remain.
