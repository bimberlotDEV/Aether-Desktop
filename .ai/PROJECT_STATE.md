...
| `ACTION-001`       | Safe Actions                                       | `self_review` | Local implementation and release gates pass; exact-head Windows CI remains.                                                         |

Milestones A through E are merged and verified. Milestone F passes local self-review on `codex/safe-actions`; exact-head Windows CI remains.
...
Milestones A through E are complete. Milestone F passes local self-review and awaits exact-head Windows CI. Public signing and updater activation remain owner-controlled release operations.
