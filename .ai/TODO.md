...
| -------- | ------------------ | -------------------------------------------------- | ---------------------------------- | -------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| P0       | `AI-ROUTER-001`    | Implement provider-neutral AI Router Phase 1       | Product / Architecture / Privacy   | `active`       | Existing AI providers, context isolation, Safe Actions | Local/Cloud/Automatic routing, native privacy/settings, and richer provenance preserve current cloud behavior without adding a local runtime or tools. |
