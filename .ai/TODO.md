...
| P0       | `RELEASE-032`      | Consolidate and install Alpha 0.3.2                        | Quality and release       | `active` | PRs #34, #35, #36 merged    | Versioned Windows artifacts are validated, hashed, installed safely, and published through a green draft PR.            |
