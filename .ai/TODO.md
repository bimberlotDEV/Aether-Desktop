...
| P0       | `ONBOARD-001`      | Complete upgrade-safe first-run onboarding                 | Product, privacy, accessibility | `in_review` | `AI-EVOL-001`, ADR-024 | Local implementation and all local gates pass; exact-head GitHub CI remains. |
| P0       | `BETA-001`         | Prepare and operate the canonical Public Beta              | Release, reliability, support | `planned` | `ONBOARD-001`, `RELEASE-TRUST-001` | Repository beta operations are complete; owner signing and meaningful external testing provide final evidence. |
