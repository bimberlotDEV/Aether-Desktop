...
| P0       | `PULSE-002`        | Make daily relevance visible on Pulse                      | Product, privacy, data    | `active`  | `CONT-001`                  | Pulse calmly surfaces Today, Continue, New, Recent, and a grounded AI entry point.                                      |
| P0       | `ACTION-001`       | Build narrow user-approved Safe Actions                    | Product, security, data   | `planned` | `PULSE-002`                 | Typed actions require Rust validation, explicit review, approval, one-time execution, and auditability.                 |
