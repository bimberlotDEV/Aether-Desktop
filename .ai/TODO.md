...
| P0       | `CONT-001`         | Build Continuity and meaningful Activity                   | Product, privacy, data    | `active` | `SEARCH-001`                | Each Space offers a concise, deterministic resume view and Activity shows only meaningful local changes.                |
