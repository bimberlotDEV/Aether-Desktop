...
| P0       | `HARD-001`         | Safely upgrade personal-beta databases                     | Defect and data lifecycle | `active` | Milestone A                 | Older databases start on 0.3.1 with valid rows and managed-file safety preserved.                                     |
