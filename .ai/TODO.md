...
| P0       | `AI-EVOL-001`      | Evolve providers, transparent Auto, and approved AI drafts | Product, security, data   | `active` | `ACTION-001`              | DeepSeek/OpenAI, deterministic routing, provenance, and Task/Note drafts reuse the Safe Actions consent boundary.        |
