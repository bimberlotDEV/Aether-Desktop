...
| P0       | `SCHOOL-BSP-REMOVE-001` | Remove the Brightspace integration              | Product / Integration / Security   | `done`         | `SCHOOL-BSP-001`, `SCHOOL-SCOPE-002`                 | Brightspace is no longer advertised, connectable, synchronizable, or School-associated; legacy state remains readable and explicitly removable without weakening shared calendar infrastructure. |
