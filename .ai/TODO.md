...
| P1       | `COMM-001`         | Build commercial-readiness foundations                     | Product, architecture, business | `active` | `BETA-001`, ADR-026 | Produce decision-ready boundaries now; implementation remains blocked on beta evidence and owner legal/business/infrastructure decisions. |
| P1       | `LAUNCH-001`       | Establish and pass the Aether 1.0 launch gate              | Reliability, release, product | `active` | `COMM-001`, ADR-026, retention evidence | Define objective gates now; passing them remains externally blocked. |
