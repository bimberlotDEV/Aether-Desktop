...
| P0       | `SEARCH-001`       | Design and implement Universal Search                      | Product, privacy, data    | `active` | `CTX-001`                   | Users search permitted local domains quickly with clear type, scope, provenance, and no implicit AI disclosure.         |
