...
| P0       | `BETA-001`         | Prepare and operate the canonical Public Beta              | Release, reliability, support | `active` | `ONBOARD-001`, `RELEASE-TRUST-001`, ADR-025 | Build privacy-safe diagnostics, support intake, test operations and evidence templates; owner signing/testing remain external. |
