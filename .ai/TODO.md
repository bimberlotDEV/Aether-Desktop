...
| P0       | `CTX-001`          | Add explicit Sources and safe metadata indexing            | Product, privacy, data    | `active` | Milestone A and ADR-016     | Users authorize, inspect, rescan, associate, and revoke bounded local directory Sources without file mutation.          |
