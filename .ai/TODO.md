...
| P1       | `UI-001`           | Redesign the complete Aether interface system              | Product and accessibility | `active` | Owner direction, ADR-015  | Every core surface feels cohesive, premium, responsive, accessible, and distinctly Aether without behavior regressions. |
