...
| P0       | `ACTION-001`       | Build narrow user-approved Safe Actions                    | Product, security, data   | `active` | `PULSE-002`                 | Typed actions require Rust validation, explicit review, approval, one-time execution, and auditability.                 |
