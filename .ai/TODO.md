...
| P0       | `CAL-CORE-001`     | Build external Calendar domain                     | Product / Data                     | `active`       | `INT-CORE-001`                                        | Aether can normalize, persist, query, update, and deduplicate external calendar events independently of provider-specific schemas.                                       |
