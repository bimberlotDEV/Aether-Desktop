...
| P0       | `RELEASE-TRUST-001` | Build trusted Windows release and update delivery          | Security, release, product | `active` | `BACKUP-RESTORE-001`, ADR-023 | Protected signed draft releases and explicit Stable updates work without exposing trust material or granting frontend installer control. |
...
| Native desktop | `release_hardening`   | Complete `RELEASE-TRUST-001`; owner then provisions production trust inputs.          |
