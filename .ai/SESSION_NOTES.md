...
Publish the task-owned changes as a draft PR, wait for exact-head CI, then record the run/head and mark `RELEASE-TRUST-001` complete. Do not invent production keys, run a live signed release, or publish generated trust configuration.
