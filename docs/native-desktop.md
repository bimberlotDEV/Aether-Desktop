...
Machine-readable package versions use `0.3.0`; Alpha remains the human-facing product maturity. Textual SemVer prerelease identifiers are intentionally avoided because Windows MSI permits only numeric prerelease/build fields.
